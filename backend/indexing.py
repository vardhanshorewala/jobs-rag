...
from backend.config import RAPIDAPI_HOST, RAPIDAPI_KEY, JOBS_ENDPOINT, MAX_JOBS_TO_FETCH
from backend.openai_utils import get_embedding
from backend.vector_store import create_chroma_client, upsert_documents
from backend.query_history import add_query_to_history
